...
var joins = [];
var oscRoutes = [];
var mubuTrack = jsarguments[1]; 
var mubuName = jsarguments[2]; 

clearNamed();
// post("using mubu track max patch " + jsarguments[1]+"\n");
	...
	if(typeof(o) == "object"){
		...
		for(var i = 0; i < a.length; i++){
			if(mubuTrackConstructorCheck(a[i])){
				...
				mubuTracks[index] = patch.newdefault(x, y + 30, mubuTrack, mubuName, a[i].trackIndex, a[i].trackName,
					"@maxsize", "360000",
